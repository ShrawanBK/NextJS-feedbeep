...
export const FeaturedArticle: React.FC<FeaturedArticleProps> = ({ article }) => {
  return (
    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-primary via-primary/90 to-accent p-8 text-primary-foreground mb-8">
      {/* Background Pattern */}
      ...
      <div className="relative z-10">
        ...
        <p className="text-primary-foreground/80 text-lg leading-relaxed mb-6 max-w-2xl">
          {article.description}
        </p>
